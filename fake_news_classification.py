...
Original file is located at
    https://colab.research.google.com/drive/1OeRhxNVzBzzS9SjBVQplN0at1bwUm9Ui

## **Import Libraries and Sort Data**
"""
...
df1 = pd.read_csv("/content/train (2).csv", sep=';')

df1.head()

df2 = pd.read_csv("/content/evaluation.csv", sep=";")

df2.head()

df3 = pd.read_csv("/content/test (1).csv", sep=";")
